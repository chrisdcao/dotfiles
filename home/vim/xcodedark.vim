...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#414453', '#ff8170', '#75c3b3', '#daca77',
        \ '#4eb0cc', '#ff78b2', '#b37eee', '#dfdfe0', '#7f8c98', '#ff8170',
        \ '#aaf2e4', '#ffa245', '#6bdfff', '#ff78b2', '#dbb8ff', '#dfdfe0']
  if has('nvim')
    let g:terminal_color_0 = '#414453'
    let g:terminal_color_1 = '#ff8170'
    let g:terminal_color_2 = '#75c3b3'
    let g:terminal_color_3 = '#daca77'
    let g:terminal_color_4 = '#4eb0cc'
    let g:terminal_color_5 = '#ff78b2'
    let g:terminal_color_6 = '#b37eee'
    let g:terminal_color_7 = '#dfdfe0'
    let g:terminal_color_8 = '#7f8c98'
    let g:terminal_color_9 = '#ff8170'
    let g:terminal_color_10 = '#aaf2e4'
    let g:terminal_color_11 = '#ffa245'
    let g:terminal_color_12 = '#6bdfff'
    let g:terminal_color_13 = '#ff78b2'
    let g:terminal_color_14 = '#dbb8ff'
  ...
  hi MoreMsg guifg=#ff78b2 guibg=NONE gui=NONE cterm=NONE
  hi WarningMsg guifg=#ffa245 guibg=NONE gui=NONE cterm=NONE
  hi Question guifg=#ff78b2 guibg=NONE gui=NONE cterm=NONE
  ...
  hi Search guifg=NONE guibg=#59595c gui=NONE cterm=NONE
  hi DiffAdd guifg=#aaf2e4 guibg=#243330 gui=NONE cterm=NONE
  hi DiffChange guifg=#ffa245 guibg=NONE gui=NONE cterm=NONE
  hi DiffDelete guifg=#ff8170 guibg=#3b2d2b gui=NONE cterm=NONE
  hi DiffText guifg=#ffa245 guibg=#382e27 gui=NONE cterm=NONE

  " hi Comment guifg=#7f8c98 guibg=NONE gui=NONE cterm=NONE
  hi Comment guifg=#52bd58 guibg=NONE gui=NONE cterm=NONE 
  hi Directory guifg=#6bdfff guibg=NONE gui=NONE cterm=NONE

  hi Error guifg=#292a30 guibg=#ff8170 gui=NONE cterm=NONE

  hi Visual guifg=#fcfcfc guibg=#0973eb gui=NONE cterm=NONE

  hi Special guifg=#75c3b3 guibg=NONE gui=NONE cterm=NONE

  "finished
  hi PreProc guifg=#ffa245 guibg=NONE gui=NONE cterm=NONE
  hi PreCondit guifg=#ffa245 guibg=NONE gui=NONE cterm=NONE
  hi Include guifg=#ff78b2 guibg=NONE gui=bold cterm=bold
  hi Define guifg=#49b0ce guibg=NONE gui=bold cterm=bold
  hi Keyword guifg=#ff78b2 guibg=NONE gui=bold cterm=bold

  "done
  hi Type guifg=#65dfff guibg=#292a30 gui=NONE cterm=NONE
  hi StorageClass guifg=#dbb8ff guibg=NONE gui=NONE cterm=NONE
  hi Structure guifg=#aaf2e4 guibg=NONE gui=bold cterm=bold
  hi Typedef guifg=#dbb8ff guibg=NONE gui=bold cterm=bold

  "done
  hi Identifier  guifg=#dbb8ff guibg=NONE gui=NONE cterm=NONE
  hi Function guifg=#75c3b3 guibg=NONE gui=NONE cterm=NONE
  hi Statement guifg=#ff78b2 guibg=NONE gui=bold cterm=bold

  "done
  hi Conditional guifg=#75c3b3 guibg=NONE gui=NONE cterm=NONE
  " hi Repeat guifg=#6396ff guibg=NONE gui=NONE cterm=NONE
  hi Repeat guifg=#b37eee guibg=NONE gui=NONE cterm=NONE
  " hi Repeat guifg=#75c3b3 guibg=NONE gui=NONE cterm=NONE

  "done
  " hi Constant guifg=#75c3b3 guibg=NONE gui=NONE cterm=NONE
  " hi Constant guifg=#b37eee guibg=NONE gui=NONE cterm=NONE
  hi Constant guifg=#daca77 guibg=NONE gui=NONE cterm=NONE
  hi Number guifg=#daca77 guibg=NONE gui=NONE cterm=NONE
  hi String guifg=#ff806c guibg=NONE gui=NONE cterm=NONE
  hi Character guifg=#daca77 guibg=NONE gui=NONE cterm=NONE
  " hi Boolean guifg=#b37eee guibg=NONE gui=NONE cterm=NONE
  hi Boolean guifg=#6396ff guibg=NONE gui=NONE cterm=NONE
  " hi Boolean guifg=#b37eee guibg=NONE gui=NONE cterm=NONE
  hi SpecialComment guifg=#a3b1bf guibg=NONE gui=NONE cterm=NONE
  " hi SpecialComment guifg=#dbb8ff guibg=NONE gui=NONE cterm=NONE

  " hi Title guifg=#ffffff guibg=NONE gui=bold cterm=bold
  hi Title guifg=#ff78b2 guibg=NONE gui=bold cterm=bold
  ...
  hi! link javaStorageClass Structure
  hi! link javaStructure StorageClass
  ...
  hi markdownDelimiter guifg=#75c3b3 guibg=NONE gui=NONE cterm=NONE
  hi markdownCode guifg=#dbb8ff guibg=#393b44 gui=NONE cterm=NONE
  ...
  if g:xcodedark_emph_types
    ...
    hi LocalType guifg=#aaf2e4 guibg=NONE gui=NONE cterm=NONE
    hi LibraryType guifg=#dbb8ff guibg=NONE gui=NONE cterm=NONE
  else
    hi Typedef guifg=#4eb0cc guibg=NONE gui=NONE cterm=NONE
    hi LocalType guifg=#75c3b3 guibg=NONE gui=NONE cterm=NONE
    hi LibraryType guifg=#b37eee guibg=NONE gui=NONE cterm=NONE
  endif
  if g:xcodedark_emph_funcs
    hi FunctionDef guifg=#6bdfff guibg=NONE gui=NONE cterm=NONE
    hi LocalFunc guifg=#aaf2e4 guibg=NONE gui=NONE cterm=NONE
    hi LibraryFunc guifg=#dbb8ff guibg=NONE gui=NONE cterm=NONE
  else
    hi FunctionDef guifg=#4eb0cc guibg=NONE gui=NONE cterm=NONE
    hi LocalFunc guifg=#75c3b3 guibg=NONE gui=NONE cterm=NONE
    hi LibraryFunc guifg=#b37eee guibg=NONE gui=NONE cterm=NONE
  endif
  if g:xcodedark_emph_idents
    hi IdentifierDef guifg=#6bdfff guibg=NONE gui=NONE cterm=NONE
    hi LocalIdent guifg=#aaf2e4 guibg=NONE gui=NONE cterm=NONE
    hi LibraryIdent guifg=#dbb8ff guibg=NONE gui=NONE cterm=NONE
  else
    hi IdentifierDef guifg=#4eb0cc guibg=NONE gui=NONE cterm=NONE
    hi LocalIdent guifg=#75c3b3 guibg=NONE gui=NONE cterm=NONE
    hi LibraryIdent guifg=#b37eee guibg=NONE gui=NONE cterm=NONE
  endif
  if g:xcodedark_match_paren_style
    hi MatchParen guifg=#292a30 guibg=#fef937 gui=NONE cterm=NONE
  else
    " hi MatchParen guifg=#fcfcfc guibg=#6b6c71 gui=NONE cterm=NONE
    hi MatchParen guifg=#fcfcfc guibg=#59595c gui=NONE cterm=NONE
  endif
  if g:xcodedark_dim_punctuation
    hi Delimiter guifg=#a3b1bf guibg=NONE gui=NONE cterm=NONE
    hi Operator guifg=#ff78b2 guibg=NONE gui=NONE cterm=NONE
  else
...
" Color: yellow       #daca77 ~
" Color: purple       #b37eee ~
" Color: light_purple #dbb8ff ~
" Color: teal         #75c3b3 ~
" Color: light_teal   #aaf2e4 ~
" Color: green        #84b360 ~
