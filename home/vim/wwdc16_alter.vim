...
let s:green = [ '#49b0ce', 76 ]  " #42a647
let s:cyan = [ '#6396ff', 14 ]
let s:base = [ '#b37eee', 121 ]
let s:violet = [ '#bc25a4', 205 ]
let s:red = [ '#bc25a4', 168 ]
let s:orange = [ '#cd9764', 180 ]
let s:dark = [ '#2d2d2f', 234 ]
let s:darker = [ '#292a30', 235 ]
let s:white = [ '#fafafa', 255 ]
"for xcodedark
"let s:gray = [ '#7f8c99', 235 ]
"let s:darkest = [ '#1d2022', 240 ]
"let s:warmdarkless = [ '#666666', 234 ]
"}}}

"{{{Definition
"xcodedark
"let s:tab_l_fg = s:gray
"let s:tab_l_bg = s:darkest
"let s:tab_r_fg = s:white
"let s:tab_r_bg = s:warmdarkless
"let s:tab_sel_fg = s:white
"let s:tab_sel_bg = s:darker
"let s:tab_middle_fg = s:violet
"let s:tab_middle_bg = s:darkest
